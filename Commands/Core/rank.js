...
module.exports={
    ...
    react:"✅",
    category: "General",
    start: async(Xtroid, m,{text,pushName,sender}) => {
...
if (levelRole <= 2) {
 ...
 var role = ' High Level Bitch'
		...
		let disc = m.sender.substring(3, 7)
			...
			try {
                    ppuser = await Xtroid.profilePictureUrl(m.sender, 'image')
                } catch {
                ...
                rank.build().then(async(data)=>{
					Xtroid.sendMessage(m.from,{image:data,caption:textr},{quoted:m})
  })
