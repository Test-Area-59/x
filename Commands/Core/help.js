module.exports = {
  ...
  start: async (
    ...
    if (args[0]) {
      ...
      return Xtroid.sendMessage(m.from, buth, { quoted: m });
    } else {
      ...
      let textHelpMenu = `Welcome *${pushName}* Senpai,

I am *${botName}*, a bot developed by *NXT-Tech*.
