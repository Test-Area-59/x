...
module.exports = {
    ...
    start: async (Xtroid, m, { text, prefix }) => {
        ...
        if(!user){
            ...
            Xtroid.sendMessage(m.from, { text: `📦 Inventory created! Use ${prefix}inventory to view your inventory.` }, { quoted: m });
        } else {
            Xtroid.sendMessage(m.from, { text: `📦 You already have an inventory. Use ${prefix}inventory to view it.` }, { quoted: m });
        }
    }
}
