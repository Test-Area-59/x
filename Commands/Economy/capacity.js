            ...
            case '1':
             if (k > balance.wallet ) return m.reply('*You need to pay 100 💎 to increase bank capacity ~ 1000 sp*');
              ...
              const add1 = eco.giveCapacity(user, cara, 1000); 
                return await Xtroid.sendMessage(m.from, { text: `*1000 💎 storage has been added in ${pushname} bank*` }, { quoted: m });
            break
           case '10000':
            case '2':
            if (k > balance.wallet ) return m.reply(`*You need to pay 💎 to increase bank capacity ~ 10000 sp*`);
              ...
              const add2 = eco.giveCapacity(user, cara, 10000); 
                  await Xtroid.sendMessage(m.from, { text: `*10000 💎 storage has been added in ${pushname} bank*` }, { quoted: m });
            break
           case '100000':
            case '3':
            if (k > balance.wallet ) return m.reply(`*You need to pay 10000 💎 to increase bank capacity ~ 100000 sp*`)
              ...
              const add3 = eco.giveCapacity(user, cara, 100000); 
                  await Xtroid.sendMessage(m.from, { text: `*100000 💎 storage has been added in ${pushname} bank*` }, { quoted: m });
             break
            }
              }
            }
