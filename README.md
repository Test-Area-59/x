...
- Changeable between `20 added Characters` ( Atlas, Power, Makima, Denji, Zero Two, Chika, Xtroid, Marin Kitagawa ) and more can be added by user inside `BotCharacters.js` file. Type `-charlist` command to get character list.
